...
export default function ProductImageGallery({
  ...
  return (
    <div className={cn('flex flex-col gap-3', className)}>
      {/* Main image */}
      <div
        className="relative aspect-square rounded-2xl overflow-hidden bg-muted border border-border/50 shadow-sm"
      ...
      {/* Thumbnail strip – hidden on mobile (dots used instead), shown on md+ */}
      {display.length > 1 && (
        <div
