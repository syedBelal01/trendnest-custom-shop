...
import { LayoutDashboard, Package, ShoppingBag, Tag, Palette, Users, LogOut, Undo2, BarChart3, ImageUp, Flame, Store, Boxes, Wallet } from 'lucide-react';
...
const links = [
  ...
  { to: '/admin/hero-banners', label: 'Hero / Sales', icon: ImageUp },
